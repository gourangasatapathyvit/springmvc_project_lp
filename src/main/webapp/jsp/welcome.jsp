...
<body>
	...
	<div class="container">
		<button type="button" class="btn btn-outline-primary">
			<a class="text-dark text-decoration-none" href="home.jsp">Home</a>
		</button>

		<button type="button" class="btn btn-outline-primary">
			<a class="text-dark text-decoration-none" href="dashboard">dashboard</a>
		</button>

		<button type="button" class="btn btn-outline-primary">
			<a class="text-dark text-decoration-none" href="proposalform">proposal</a>
		</button>
